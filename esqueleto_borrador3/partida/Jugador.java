...
public class Jugador {
    ...
    private int enBancarrota;    //0 si el jugador no está en bancarrota; 1 si está en bancarrota
    ...
    public Jugador(String nombre, String tipoAvatar, Casilla inicio, ArrayList<Avatar> avCreados) {
        ...
        this.vueltas = 0;
        this.propiedades = new ArrayList<>();
        this.enBancarrota = 0;       //No es posible que un jugador empiece la partida estando ya en bancarrota
    ...
    //Método para saber si un jugador tiene suficiente dinero para pagar, y declarar en bancarrota si no puede
    public boolean puedePagar(float valor) {
       ...
       if(this.fortuna + valor >= 0) {         //Si al restar el valor que hay que pagar, sigue quedando un valor positivo, entonces se puede pagar
           ...
           this.enBancarrota = 1;       //Se declara al jugador en bancarrota
