...
public class Avatar {
    ...
    * EN ESTA VERSIÓN SUPONEMOS QUE valorTirada siemrpe es positivo.
    ...
    public void moverAvatarHasta(String nombreCasilla, ArrayList<ArrayList<Casilla>> casillas, Tablero tablero) {
        ...
        int posDestino = -1;
        for (int i = 0; i < todasCasillas.size(); i++) {
            if (todasCasillas.get(i) == this.lugar) posActual = i;
            if (todasCasillas.get(i).getNombre().equalsIgnoreCase(nombreCasilla)) posDestino = i;
        }
        ...
        // Chamamos ao método principal que xa tes
        this.moverAvatar(casillas, pasos, tablero);
    }
