...
public class Tablero {
    ...
    private void insertarLadoOeste() {
        ...
        oeste.add(new Casilla("Parking", "Especial", 21, banca));
    ...
    public String toString() {
        ...
        for (int lado = 0; lado < posiciones.size(); lado++) {
            sb.append("Lado ").append(lado).append(":\n");
            for (Casilla c : posiciones.get(lado)) {
                sb.append("  ").append(c.getNombre())
                        .append(" (").append(c.getTipo()).append(")")
                        .append(" pos=").append(c.getPosicion())
                        .append("\n");
            }
        }
