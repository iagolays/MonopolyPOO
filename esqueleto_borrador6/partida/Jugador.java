...
public class Jugador {
    ...
    public void anhadirPropiedad(Casilla casilla) {
        if (casilla!= null && !propiedades.contains(casilla)) { //compóbase que un xogador non teña esa propiedade
            ...
            System.out.println(this.nombre + " adquire a propiedade: " + casilla.getNombre());
        }
    }
    ...
    public void sumarFortuna(float valor) {
        this.fortuna += valor;
        if (valor > 0){
            System.out.println(this.nombre + " recibe " + (int)valor + "€. A súa fortuna é: " + (int)this.fortuna + "€");
        } else {
            this.sumarGastos(Math.abs(valor)); // Usamos valor absoluto para evitar gastos negativos
            System.out.println(this.nombre + " paga " + (int)Math.abs(valor) + "€. A súa fortuna é: " + (int)this.fortuna + "€");
        }
    }
    ...
    public void encarcelar(ArrayList<ArrayList<Casilla>> pos) {
        ...
        if (carcel != null && this.avatar != null) {
            ...
            System.out.println("O xogador " + this.nombre + " foi enviado ao cárcere.");
        }
    }
    ...
    public boolean pagarJugador(Jugador receptor, float cantidad) {
        if (this.puedePagar(cantidad)) {
            ...
            System.out.println(this.nombre + " paga " + (int)cantidad + "€ de alquiler a " + receptor.nombre);
            return true;
        } else {
