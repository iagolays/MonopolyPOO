...
public class Solares {
    ...
    public static class DatosSolar {
        public float precio; // Prezo de compra do solar
        public float alquiler; // Aluguer base do solar
        public float valorCasa; // Valor para construír unha casa
        public float valorHotel; // Valor para construír un hotel
        public float valorPiscina; // Valor para construír unha piscina
        public float valorPista; // Valor para construír unha pista de deporte
        public float alquilerCasa; // Aluguer cando ten casa
        public float alquilerHotel; // Aluguer cando ten hotel
        public float alquilerPiscina; // Aluguer cando ten piscina
        public float alquilerPista; // Aluguer cando ten pista de deporte
    ...
    // Mapa onde gardamos todos os datos dos solares
    public static final Map<String, DatosSolar> DATOS = new HashMap<>();


    static { // Bloque estático - execútase ao cargar a clase
        // Solar 1
    ...
    // Metodo para obter o prezo da casa
    ...
    // Metodo para obter precio hotel
    ...
    // Metodo para obter precio piscina
    ...
    // Metodo para obter precio pista
    ...
    // Metodo para obter alquiler casa
    ...
    // Metodo para obter alquiler hotel
    ...
    // Metodo para obter alquiler Piscina
    ...
    // Metodo para obter alquiler pista
